        ...
        {{-- landing page --}}
            ...
            <div id="skills" class=" h-screen bg-gradient-to-b from-peach to-lavenderGray text-navy">
                ...
                <div class="flex flex-row justify-center p-12">
                    <div>
                        <div class="bg-white rounded-full w-36 h-36 mr-8 ml-8 flex justify-center items-center hover:-translate-y-1 hover:scale-150 ease-in hover:bg-navy duration-300 ">
                            ...
                            <div class="absolute opacity-0 hover:opacity-100 duration-300 inset-0 z-10 flex justify-center mt-6 text-xs hover:text-peach text-white font-semibold">4/5</div>
                        </div>
